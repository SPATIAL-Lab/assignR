...
Let's compare probabilities for two spatial areas defined by the summer and winter ranges of the Mountain Plover. Yes, this is a different species than we are working with, and in most cases we would not be trying to distinguish between winter and summer habitats, but it provides a nice example!
...
*****
Combine the fuzzy isoscape with the original isoscape uncertainty layer, and rerun *QA* using the new version of the isoscape.
