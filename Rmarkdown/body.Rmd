...
```{r calRaster, fig.width=5, fig.asp=0.8, out.width='90%'}
...
```{r pdRaster, fig.width=5, fig.asp=0.8, out.width='95%'}
...
```{r Dp_Honly, fig.width=5, fig.asp=1.6, out.width='90%'}
...
```{r Dp_multi, fig.width=5, fig.asp=1.6, out.width='90%'}
